...
class HelloWorld {
    ...
    async started() {
        ...
        for (let i = 0; i < 20; i++) {
            const curtainPiece = MRESDK.Actor.CreateEmpty(this.context, {
                actor: {
                    ...
                    name: `curtain${i}`,
                    transform: {
                        rotation: mixed_reality_extension_sdk_1.Quaternion.FromEulerAngles(0, (-47.5 + (i * 5)) * mixed_reality_extension_sdk_1.DegreesToRadians, 0)
                    }
                }
            });
            MRESDK.Actor.CreateFromGLTF(this.context, {
                ...
                actor: {
                    ...
                    transform: {
                        ...
                        rotation: mixed_reality_extension_sdk_1.Quaternion.FromEulerAngles(90 * mixed_reality_extension_sdk_1.DegreesToRadians, 0, 0)
                    }
                }
            });
        }
        ...
        for (let i = 1; i < 19; i++) {
            this.curtains.children[i].createAnimation({
                animationName: "Open",
                keyframes: this.generateCurtainframes(i < 10 ? 0 + (.5 * i) : 4.5 - (.5 * (i - 10)), -47.5 + (5 * i), i < 10 ? -47.5 : 47.5, 0),
                events: []
            }).catch(reason => this.context.logger.log('error', `Failed to create spin animation: ${reason}`));
            this.curtains.children[i].createAnimation({
                animationName: "Close",
                keyframes: this.generateCurtainframes(i < 10 ? 0 + (.5 * i) : 4.5 - (.5 * (i - 10)), i < 10 ? -47.5 : 47.5, -47.5 + (5 * i), i < 10 ? 4.5 - (.5 * i) : 0 + (.5 * (i - 10))),
                events: []
            }).catch(reason => this.context.logger.log('error', `Failed to create spin animation: ${reason}`));
        }
        ...
        const curtainPanel = MRESDK.Actor.CreateEmpty(this.context, {
            actor: {
                ...
                transform: {
                    rotation: mixed_reality_extension_sdk_1.Quaternion.FromEulerAngles(-30 * mixed_reality_extension_sdk_1.DegreesToRadians, 0, 0)
                }
            }
        });
        ...
        const openButtonPromise = mixed_reality_extension_sdk_1.Actor.CreateFromGLTF(this.context, {
            ...
            actor: {
                ...
                transform: {
                    ...
                    rotation: mixed_reality_extension_sdk_1.Quaternion.FromEulerAngles(0, 180 * mixed_reality_extension_sdk_1.DegreesToRadians, 0)
                },
                text: {
                    contents: '\n\nOpen',
                    anchor: mixed_reality_extension_sdk_1.TextAnchorLocation.TopCenter,
                    color: { r: 1, g: 1, b: 1 },
                    height: 0.6,
                    justify: mixed_reality_extension_sdk_1.TextJustify.Center
                }
            }
        });
        const closeButtonPromise = mixed_reality_extension_sdk_1.Actor.CreateFromGLTF(this.context, {
        ...
        const leftButtonPromise = mixed_reality_extension_sdk_1.Actor.CreateFromGLTF(this.context, {
            resourceUrl: `${url}/redCube.gltf`,
            colliderType: 'box',
            actor: {
                parentId: curtainPanel.value.id,
        ...
        const centerButtonPromise = mixed_reality_extension_sdk_1.Actor.CreateFromGLTF(this.context, {
            resourceUrl: `${url}/redCube.gltf`,
            colliderType: 'box',
            actor: {
                parentId: curtainPanel.value.id,
        ...
        const rightButtonPromise = mixed_reality_extension_sdk_1.Actor.CreateFromGLTF(this.context, {
            resourceUrl: `${url}/redCube.gltf`,
            colliderType: 'box',
            actor: {
                parentId: curtainPanel.value.id,
        ...
        const centerPartButtonPromise = mixed_reality_extension_sdk_1.Actor.CreateFromGLTF(this.context, {
            resourceUrl: `${url}/redCube.gltf`,
            colliderType: 'box',
            actor: {
                parentId: curtainPanel.value.id,
     ...
     */
    generateCurtainframes(dur, from, to, delay) {
        return [{
                time: delay + (0 * dur),
                value: { transform: { rotation: mixed_reality_extension_sdk_1.Quaternion.RotationAxis(mixed_reality_extension_sdk_1.Vector3.Up(), from * mixed_reality_extension_sdk_1.DegreesToRadians) } }
            }, {
                time: delay + (0.5 * dur),
                value: { transform: { rotation: mixed_reality_extension_sdk_1.Quaternion.RotationAxis(mixed_reality_extension_sdk_1.Vector3.Up(), ((from + to) / 2) * mixed_reality_extension_sdk_1.DegreesToRadians) } }
            }, {
                time: delay + (1 * dur),
                value: { transform: { rotation: mixed_reality_extension_sdk_1.Quaternion.RotationAxis(mixed_reality_extension_sdk_1.Vector3.Up(), to * mixed_reality_extension_sdk_1.DegreesToRadians) } }
            }, {
                time: delay + (1.1 * dur),
                value: { transform: { rotation: mixed_reality_extension_sdk_1.Quaternion.RotationAxis(mixed_reality_extension_sdk_1.Vector3.Up(), to * mixed_reality_extension_sdk_1.DegreesToRadians) } }
            }];
